module {
  func.func @test_lif(%arg0: tensor<2x2xf32>, %arg1: tensor<2x2xf32>) -> tensor<2x2xf32> {
    ...
    %5 = scf.for %arg2 = %c0 to %c2 step %c1 iter_args(%arg3 = %3) -> (tensor<2x2xf32>) {
      %6 = scf.for %arg4 = %c0 to %c2_6 step %c1 iter_args(%arg5 = %arg3) -> (tensor<2x2xf32>) {
        %extracted = tensor.extract %4[%arg2, %arg4] : tensor<2x2xi1>
        %7 = scf.if %extracted -> (tensor<2x2xf32>) {
          %inserted = tensor.insert %cst_7 into %arg5[%arg2, %arg4] : tensor<2x2xf32>
          scf.yield %inserted : tensor<2x2xf32>
        } else {
          %inserted = tensor.insert %cst_8 into %arg5[%arg2, %arg4] : tensor<2x2xf32>
          scf.yield %inserted : tensor<2x2xf32>
        }
        scf.yield %7 : tensor<2x2xf32>
      }
