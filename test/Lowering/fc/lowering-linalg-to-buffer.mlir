...
// CHECK-NEXT: [[V1:%[0-9a-zA-Z_]*]] = memref.get_global @__constant_1xf32 : memref<1xf32>
// CHECK-NEXT: [[V2:%[0-9a-zA-Z_]*]] = memref.get_global @__constant_1x1xf32 : memref<1x1xf32>
...
// CHECK-NEXT: linalg.generic {indexing_maps = [#[[$MAP0]], #[[$MAP1]]], iterator_types = ["parallel", "parallel"]} ins([[V1]] : memref<1xf32>) outs([[ARG1]] : memref<2x1xf32>) {
...
// CHECK-NEXT: linalg.matmul ins([[ARG0]], [[V2]] : memref<2x1xf32>, memref<1x1xf32>) outs([[ARG1]] : memref<2x1xf32>)
